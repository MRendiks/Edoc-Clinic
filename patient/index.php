            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Penjadwalan Sesi</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Booking Ku</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Tidak tahu tentang dokter? tidak masalah mari kita melompat ke bagian
                                <a href="doctors.php" class="non-style-link"><b>"Semua Dokter"</b></a> Atau
                                <a href="schedule.php" class="non-style-link"><b>"Sesi"</b> </a><br>
                                Lacak riwayat janji temu masa lalu dan masa depan Anda.<br>Cari tahu juga perkiraan waktu kedatangan dokter atau konsultan medis Anda.<br><br>
                            </p>
                            
                            <h3>Cari Dokter Di Sini</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Cari Dokter dan Kami akan Menemukan Sesi yang Tersedia" list="doctors" style="width:45%;">&nbsp;&nbsp;
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;" class="anime">Booking Anda yang Akan Datang</p>
                                    <center>
